(Look, this is just an experiment to see what will happen if I backport to Spring Boot 2.7.18. I don't know if it will work. It probably won't. But right now I can't use Spring 3.x and it really sucks. I'm
